# hils_bridge_lidar_livox_mid360
...
```bash
cd ~/colcon_ws
colcon build --packages-select hils_bridge_lidar_livox_mid360
...
ros2 launch hils_bridge_lidar_livox_mid360 livox_bridge.launch.py
```
